...
def test_market_schedule():
    ...
    print("\n🧪 Тест разного времени:")
    test_times = [
        datetime(2025, 9, 19, 5, 30),   # Четверг 05:30 - закрыт, форекс недоступен
        datetime(2025, 9, 19, 10, 0),   # Четверг 10:00 - открыт, форекс доступен
        datetime(2025, 9, 19, 23, 0),   # Четверг 23:00 - закрыт, форекс недоступен
        datetime(2025, 9, 21, 12, 0),   # Суббота 12:00 - закрыт, форекс доступен
        datetime(2025, 9, 22, 12, 0),   # Воскресенье 12:00 - закрыт, форекс доступен
    ]
